...
CREATE TABLE `railway_lines` (
  ...
  `steam_or_diesel` enum('Steam','Diesel') DEFAULT NULL,
...
INSERT INTO `station_stops` VALUES (1,1,2,'York',1,0,'Historic station'),(2,1,3,'Leeds',0,0,'Busy transfer point'),(3,1,NULL,'Edinburgh',0,1,'Scenic destination'),(4,2,5,'Swindon',1,0,'Freight hub'),(5,2,NULL,'Bristol',0,1,'Major city'),(6,3,7,'Brighton',1,0,'Seaside town'),(7,3,NULL,'Eastbourne',0,1,'Tourist favorite'),(8,4,9,'London Victoria',1,0,'Central London'),(9,4,10,'Gatwick Airport',0,1,'International connection'),(10,4,NULL,'Unknown',0,0,'Placeholder station');
...
INSERT INTO `users` VALUES (1,'user','pass','admin'),(2,'testuser','testpassword','admin'),(3,'jhonny','test','admin');
...
-- Dump completed on 2024-12-15 19:58:00
